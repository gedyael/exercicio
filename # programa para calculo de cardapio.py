...
def soma():
        ...
        if codigo ==1:                                                                                                                                           
            ...
            print("                                      ")
            print("O VALOR DO SEU LANCHE FOI DE","R$" "%.2f"%somar1)
            print("______________________________________")
        if codigo ==2:
            dois * quantidade
            print("                                      ")
            print("O VALOR DO SEU LANCHE FOI DE","R$" "%.2f"%somar2)
            print("______________________________________")   
        if codigo ==3:
            tres * quantidade
            print("                                      ")
            print("O VALOR DO SEU LANCHE FOI DE","R$" "%.2f"%somar3)
            print("______________________________________")
        if codigo ==4:
            quatro * quantidade
            print("                                      ")
            print("O VALOR DO SEU LANCHE FOI DE","R$" "%.2f"%somar4)
            print("______________________________________")
        if codigo ==5:
            cinco * quantidade
            print("                                      ")
